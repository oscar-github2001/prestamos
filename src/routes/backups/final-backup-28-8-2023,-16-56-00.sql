...
VALUES
  (
    'VqdwZBkpv4V_idZJAr6svmeOhswg20mZ',
    1693349760,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{},\"loggedin\":true,\"usuario\":1,\"userId\":1,\"name\":\"oscar\"}'
  );
INSERT INTO
...
VALUES
  (128, 1, 1, '2023-09-28', 21.250, 16.150, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (129, 1, 2, '2023-10-28', 21.250, 14.131, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (130, 1, 3, '2023-11-28', 21.250, 12.113, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (131, 1, 4, '2023-12-28', 21.250, 10.094, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (132, 1, 5, '2024-01-28', 21.250, 8.075, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (133, 1, 6, '2024-02-28', 21.250, 6.056, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (134, 1, 7, '2024-03-28', 21.250, 4.038, 30.334, 1);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (135, 1, 8, '2024-04-28', 21.250, 2.019, 30.334, 1);
