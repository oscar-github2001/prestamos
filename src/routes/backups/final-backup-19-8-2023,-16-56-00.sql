...
VALUES
  (
    ...
    '4011702021000I',
    '78992344',
    'Del Palí, 20 mtrs al Este',
    'jose@gmail.com',
    '$2a$10$aPbttrFMn3tWOpk6Sfgblej4Fx5H/dAFIB9upNIz7Yi/PXEL.DUTa',
    'Soltero',
    '1',
    '2023-08-15 16:23:10',
    1,
...
VALUES
  (
    ...
    'eliezer@gmail.com',
    '$2a$10$mZG3diFP31IBYiWzwR4tNeHxUFBa4ahf//Yp2fSt5GKIJOhyoopG2',
    'Soltero',
    '1',
    '2023-08-15 16:53:40',
    3,
...
VALUES
  (
    ...
    'Arena, 150mts al Norte',
    'oscar',
    '$2a$10$vzexAigKwbX2C1XABoKGLuhh7wI8VGjIpBYpOnvyy1AHEEgTPD5uu',
    'Soltero',
    '1',
    '2023-08-15 17:16:34',
    2,
...
VALUES
  (
    ...
    '4011602021000R',
    '78989932',
    'Parque central, la concepción',
    'juan@gmail.com',
    '$2a$10$71ZpVyzTDIL1ikHvz/w62uNIFyDm77Vv9QT1qFtt6sKrQcqaz0quq',
    'Casada',
    '1',
    '2023-08-15 17:21:03',
    1,
...
VALUES
  (
    ...
    'Arena, 150mts al Norte',
    'roger@gmail.com',
    '$2a$10$Q/1Kpt32e13z6CeErqwJzutahLknMH4pcucMbg1brxhPNSspc3BLe',
    'Soltero',
    '1',
    '2023-08-15 18:15:08',
    2,
...
VALUES
  (9, 2, 1, '2023-02-01', 21.250, 16.150, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (10, 2, 2, '2023-03-01', 21.250, 14.131, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (11, 2, 3, '2023-04-01', 21.250, 12.113, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (12, 2, 4, '2023-05-01', 21.250, 10.094, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (13, 2, 5, '2023-06-01', 21.250, 8.075, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (14, 2, 6, '2023-07-01', 21.250, 6.056, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (15, 2, 7, '2023-08-01', 21.250, 4.038, 30.334, 2);
INSERT INTO
  `tblcuotas` (
    `idcuota`,
    `idprestamoFK`,
...
VALUES
  (16, 2, 8, '2023-09-01', 21.250, 2.019, 30.334, 2);
...
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (9, 30.334, 9, '2023-08-13 17:39:17');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (10, 30.334, 10, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (11, 30.334, 11, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (12, 30.334, 12, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (13, 30.334, 13, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (14, 30.334, 14, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (15, 30.334, 15, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (16, 7.996, 16, '2023-08-13 18:08:01');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (17, 10.000, 16, '2023-08-13 18:08:18');
INSERT INTO
  `tblpagos` (`idpago`, `pago`, `idcuotaFK`, `fecha_pago`)
VALUES
  (18, 12.338, 16, '2023-08-15 14:34:40');
